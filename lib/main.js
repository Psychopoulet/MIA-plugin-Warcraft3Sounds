					...
					if (!race) {
						...
						this.database.getCharacters(race).then((characters) => {
							...
							characters.forEach((character, key) => {
								...
								characters[key].actionurl = BASIC_URL + "races/" + race.code + "/characters/" + character.code + "/actions";
							});
					...
					if (!race) {
						...
						this.database.getCharacter(race, req.params.character).then((character) => {
							...
							if (!character) {
								...
								character.actionurl = BASIC_URL + "races/" + race.code + "/characters/" + character.code + "/actions";
